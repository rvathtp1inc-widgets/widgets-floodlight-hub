import { useDiagnosticsCommands, useDiagnosticsEvents, useDiagnosticsHealth, useVirtualSecurityPanelStatus } from '../hooks/useDiagnostics';
...
export function Dashboard() {
  ...
  return <section className="space-y-4">
    ...
    <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
      ...
      <VirtualSecurityPanelStatusCard status={vspStatus.data} isLoading={vspStatus.isLoading} isError={vspStatus.isError} isFetching={vspStatus.isFetching} />
    </div>
